...
Original file is located at
    https://colab.research.google.com/drive/12FpqhvTkopaMzd6sxmNliZ1-rIIjt_nw
...
myplaylist2 = MusicPlaylist()
myplaylist2.add_song("titleM1","ar1")
myplaylist2.add_song("titleM2","ar2")
myplaylist2.play_current_song()
myplaylist2.next_song()
myplaylist2.prev_song()
...
!ngrok authtoken  36GtzZt6hs64Yte8kxZCDzcjgMG_zkxLfMPN82JCyQmbawqB
